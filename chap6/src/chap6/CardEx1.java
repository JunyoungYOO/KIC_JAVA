...
//		System.out.println("카드의 종류:" + Card.kind + "," + Card.number );	>>객체가 생성되지 않았기떄문에 인스턴스 변수인 .kind, .number 호출불가
		Card c1 = new Card();
		...
		System.out.println("c2카드:" + c2.kind + "," + c2.number+",("+c2.width+","+c2.height+")" );
		c1.width = 100;
		c1.height = 50;
		System.out.println("c1카드:" + c1.kind + "," + c1.number +",("+c1.width+","+c1.height+")" );
        System.out.println("c2카드:" + c2.kind + "," + c2.number+",("+c2.width+","+c2.height+")" );
	}
}